...
class HistoryFragment : Fragment() {
    ...
    private fun initVar(view: View) {
        iv = view.findViewById(R.id.iv_history_fragment_off)
        txt = view.findViewById(R.id.txt_history_fragment_off_desc)
    }

    private fun initRecyclerView(view: View) {
        rv = view.findViewById(R.id.rv_history_fragment)
    ...
    private fun initObserver() {
        historyViewModel.getAll().observe(viewLifecycleOwner, Observer {
